...
<h1>Hello  Doctor, <c:out value="${login}" />!</h1>
    ...
    <c:forEach var="patient" items="${requestScope.patients}">
        <li>
            ...
            <span><form action="<c:url value='/change/patient/prescripts'/>" method="POST">
                <div><input name="diagnosis" type="text"  placeholder="Diagnosis: " value="<c:out value='${patient.diagnosis}'/>"></div>
                ...
                <div><input name="operations" type="text"  placeholder="Operations: " value="<c:out value='${patient.operations}'/>"></div>
