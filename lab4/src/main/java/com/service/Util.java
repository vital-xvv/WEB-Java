...
public class Util {
    ...
    private static final Pattern usernamePattern = Pattern.compile("^([a-zA-Z])[a-zA-Z0-9-.]{3,}");private static final List<String> doctorCategories = List.of("pediatrician", "neurosurgeon", "dentist",
